...
namespace Asset
{
	...
	namespace Bone
	{
		...
		const AssetID locke_ball_l = 47;
		const AssetID locke_ball_r = 51;
		const AssetID locke_calf_l = 45;
		const AssetID locke_calf_r = 49;
		const AssetID locke_clavicle_l = 4;
		const AssetID locke_clavicle_r = 23;
		const AssetID locke_foot_l = 46;
		const AssetID locke_foot_r = 50;
		const AssetID locke_hand_l = 7;
		const AssetID locke_hand_r = 26;
		const AssetID locke_head = 43;
		const AssetID locke_index_01_l = 8;
		const AssetID locke_index_01_r = 27;
		const AssetID locke_index_02_l = 9;
		const AssetID locke_index_02_r = 28;
		const AssetID locke_index_03_l = 10;
		const AssetID locke_index_03_r = 29;
		const AssetID locke_lowerarm_l = 6;
		const AssetID locke_lowerarm_r = 25;
		const AssetID locke_middle_01_l = 11;
		const AssetID locke_middle_01_r = 30;
		const AssetID locke_middle_02_l = 12;
		const AssetID locke_middle_02_r = 31;
		const AssetID locke_middle_03_l = 13;
		const AssetID locke_middle_03_r = 32;
		const AssetID locke_neck_01 = 42;
		const AssetID locke_pelvis = 0;
		const AssetID locke_pinky_01_l = 14;
		const AssetID locke_pinky_01_r = 33;
		const AssetID locke_pinky_02_l = 15;
		const AssetID locke_pinky_02_r = 34;
		const AssetID locke_pinky_03_l = 16;
		const AssetID locke_pinky_03_r = 35;
		const AssetID locke_ring_01_l = 17;
		const AssetID locke_ring_01_r = 36;
		const AssetID locke_ring_02_l = 18;
		const AssetID locke_ring_02_r = 37;
		const AssetID locke_ring_03_l = 19;
		const AssetID locke_ring_03_r = 38;
		const AssetID locke_spine_01 = 1;
		const AssetID locke_spine_02 = 2;
		const AssetID locke_spine_03 = 3;
		const AssetID locke_thigh_l = 44;
		const AssetID locke_thigh_r = 48;
		const AssetID locke_thumb_01_l = 20;
		const AssetID locke_thumb_01_r = 39;
		const AssetID locke_thumb_02_l = 21;
		const AssetID locke_thumb_02_r = 40;
		const AssetID locke_thumb_03_l = 22;
		const AssetID locke_thumb_03_r = 41;
		const AssetID locke_upperarm_l = 5;
		const AssetID locke_upperarm_r = 24;
