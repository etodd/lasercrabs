...
namespace Asset
{
	namespace String
	{
		...
		const AssetID msg_aldus_intro = 314;
		const AssetID msg_aldus_keep_trying = 315;
		const AssetID msg_cora_intro = 316;
		const AssetID msg_ivory_intro = 317;
		...
		const AssetID prompt_call = 336;
		const AssetID prompt_cancel = 337;
		const AssetID prompt_cancel_ability = 338;
		const AssetID prompt_cancel_hack = 339;
		const AssetID prompt_capture = 340;
		const AssetID prompt_defend = 341;
		const AssetID prompt_deploy = 342;
		const AssetID prompt_hack = 343;
		const AssetID prompt_interact = 344;
		const AssetID prompt_join_group_queue = 345;
		const AssetID prompt_splitscreen = 346;
		const AssetID prompt_splitscreen_ready = 347;
		const AssetID prompt_upgrade = 348;
		const AssetID prompt_zone_defend = 349;
		const AssetID quit = 350;
		const AssetID resource_collected = 351;
		const AssetID right_joystick = 352;
		const AssetID rocket = 353;
		const AssetID rocket_incoming = 354;
		...
		const AssetID tut_health = 389;
		const AssetID tut_kill_player = 390;
		const AssetID tut_minion = 391;
