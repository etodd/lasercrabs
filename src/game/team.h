...
#define PLAYER_SPAWN_DELAY_PVP 5.0f
#define PLAYER_SPAWN_DELAY_PARKOUR 3.0f
#define GAME_TIME_LIMIT ((60.0f * 10.0f) + PLAYER_SPAWN_DELAY_PVP)
#define GAME_BUY_PERIOD (10.0f + PLAYER_SPAWN_DELAY_PVP)
