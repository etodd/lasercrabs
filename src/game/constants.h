...
#define NET_MAX_SEQUENCE_GAP 128
...
#define AWK_SHIELD_ALPHA 0.3f
#define AWK_OVERSHIELD_ALPHA 0.5f
#define AWK_OVERSHIELD_RADIUS (AWK_SHIELD_RADIUS * 1.667f)
#define AWK_SHIELD_VIEW_RATIO 0.6f
...
#define PROJECTILE_LIGHT_RADIUS 10.0f
