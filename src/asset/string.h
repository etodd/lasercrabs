...
namespace Asset
{
	namespace String
	{
		...
		const AssetID sensitivity = 350;
		const AssetID sensor = 351;
		const AssetID sensor_destroyed = 352;
		const AssetID sfx = 353;
		const AssetID shield = 354;
		const AssetID shield_down = 355;
		const AssetID sniper = 356;
		const AssetID spectating = 357;
		const AssetID splitscreen = 358;
		const AssetID starting_capture = 359;
		const AssetID stealth = 360;
		const AssetID tab_inventory = 361;
		const AssetID tab_map = 362;
		const AssetID tab_messages = 363;
		const AssetID target_shield_down = 364;
		const AssetID team_a = 365;
		const AssetID team_b = 366;
		const AssetID team_c = 367;
		const AssetID team_d = 368;
		...
		const AssetID zones_captured = 396;
		const AssetID zones_hostile = 397;
		const AssetID zones_locked = 398;
	}
}
