...
namespace AI
{
	...
	struct RecordedLife
	{
		...
		static const s8 EntityBoltEnemy = 17;
		static const s8 EntityBoltFriend = 18;
		...
		static const s8 EntitySpawnPointFriend = 23;
		static const s8 EntitySpawnPointEnemy = 24;
		static const s8 EntityTurretFriend = 25;
		static const s8 EntityTurretEnemy = 26;
		static const s8 EntityCoreModuleInvincible = 27;
		static const s8 EntityCoreModuleVulnerable = 28;
