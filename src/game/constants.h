...
#define BATTERY_ENERGY_INCREMENT_TIME 15.0f
#define BATTERY_SPAWN_DELAY 10.0f
#define BATTERY_TIME_REWARD (BATTERY_SPAWN_DELAY + (BATTERY_ENERGY_INCREMENT_TIME * 10.0f))

#define DEFAULT_ASSAULT_TIME_LIMIT_MINUTES 5 // twice the time it takes to capture a battery; attackers need to hold the battery 50% of the time to win
