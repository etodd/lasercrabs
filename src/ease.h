...
namespace Ease
{
	...
	template<typename T> T linear(r32 x, T start = 0.0f, T end = 1.0f)
	{
		return (end - start) * x + start;
	}
			
	// quadratic easing in - accelerating from zero velocity
	template<typename T> T quad_in(r32 x, T start = 0.0f, T end = 1.0f)
	{
		return (end - start) * x * x + start;
	}
			
	// quadratic easing out - decelerating to zero velocity
	template<typename T> T quad_out(r32 x, T start = 0.0f, T end = 1.0f)
	{
		return (start - end) * x * (x - 2.0f) + start;
	};

	// quadratic easing in/out - acceleration until halfway, then deceleration
	template<typename T> T quad_in_out(r32 x, T start = 0.0f, T end = 1.0f)
	{
		T c = end - start;
		x *= 2.0f;
		if (x < 1.0f)
	...
	template<typename T> T cubic_in(r32 x, T start = 0.0f, T end = 1.0f)
	{
		T c = end - start;
	...
	template<typename T> T cubic_out(r32 x, T start = 0.0f, T end = 1.0f)
	{
		x--;
	...
	template<typename T> T cubic_in_out(r32 x, T start = 0.0f, T end = 1.0f)
	{
		T c = end - start;
		x *= 2.0f;
		if (x < 1.0f)
	...
	template<typename T> T quart_in(r32 x, T start = 0.0f, T end = 1.0f)
	{
		return (end - start) * x * x * x * x + start;
	}

	// quartic easing out - decelerating to zero velocity
	template<typename T> T quart_out(r32 x, T start = 0.0f, T end = 1.0f)
	{
		x--;
	...
	template<typename T> T quart_in_out(r32 x, T start = 0.0f, T end = 1.0f)
	{
		T c = end - start;
		x *= 2.0f;
		if (x < 1.0f)
	...
	template<typename T> T sin_in(r32 x, T start = 0.0f, T end = 1.0f)
	{
		T c = end - start;
	...
	template<typename T> T sin_out(r32 x, T start = 0.0f, T end = 1.0f)
	{
		return (end - start) * sinf(x * HALF_PI) + start;
	}

	// sinusoidal easing in/out - accelerating until halfway, then decelerating
	template<typename T> T sin_in_out(r32 x, T start = 0.0f, T end = 1.0f)
	{
		T c = end - start;
	...
	template<typename T> T expo_in(r32 x, T start = 0.0f, T end = 1.0f)
	{
	...
	template<typename T> T expo_in_out(r32 x, T start = 0.0f, T end = 1.0f)
	{
		T c = end - start;
		x *= 2.0f;
		if (x < 1.0f)
	...
	template<typename T> T circ_in(r32 x, T start = 0.0f, T end = 1.0f)
	{
		return (start - end) * (sqrtf(1.0f - x * x) - 1.0f) + start;
	}

	// circular easing out - decelerating to zero velocity
	template<typename T> T circ_out(r32 x, T start = 0.0f, T end = 1.0f)
	{
		x--;
	...
	template<typename T> T circ_in_out(r32 x, T start = 0.0f, T end = 1.0f)
	{
		T c = end - start;
		x *= 2.0f;
		if (x < 1.0f)
	...
	template<typename T> T ease(Type t, r32 x, T start = 0.0f, T end = 1.0f)
	{
		switch (t)
		{
			case Type::Linear:
